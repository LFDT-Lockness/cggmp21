...
\algoInputsList{
    ...
    \item public data $(N_i, C) \in \Z^2$,
    \item secret data $(x, y) \in \Z^2$
}
\algoOutputsList{
...
\algoInputsList{
    ...
    \item auxiliary data $R_j = (s, t, \dots) \in (\Z, \Z, \dots)$
    \item public data $(N_j, N_i, C, D, Y, X) \in (\Z, \Z, \Z, \Z, \Z, \E)$
...
Common (public) input:
    ...
    verifier's auxiliary data $R_j = (N_j, s_j, t_j) \in (\Z, \Z^*_{N_j}, \Z^*_{N_j})$,
